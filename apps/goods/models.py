...
class GoodsCategory(models.Model):
    ...
    category_type = models.CharField(max_length=2, choices=choice_category_type, verbose_name='类目级别', help_text='类目级别')
...
class Goods(models.Model):
    ...
    goods_front_image = models.ImageField(max_length=300, default='', verbose_name='封面图')
